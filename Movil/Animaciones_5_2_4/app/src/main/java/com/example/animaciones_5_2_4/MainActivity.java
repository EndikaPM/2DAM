package com.example.animaciones_5_2_4;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView texto = (TextView) findViewById(R.id.idMain);
        texto.setAnimation(miAnimacion);
        ...
        TextView tex = (TextView) findViewById(R.id.idBye);
